                ...
                <Block row space="between">
                  <Block row>
                    <Block middle style={styles.pro}>
                      <Text size={16} color="white">Mother</Text>
                    </Block>
                    <Text color="white" size={16} muted style={styles.seller}>Boy</Text>
                    <Text size={16} color={materialTheme.COLORS.WARNING}>
                      14 / 1 / 2023<Icon name="shape-star" family="GalioExtra" size={14} />
                    </Text>
                  </Block>
                  <Block>
                    <Text color={theme.COLORS.MUTED} size={16}>
                      <Icon name="map-marker" family="font-awesome" color={theme.COLORS.MUTED} size={16} />
                      {` `} Track Your Next Fertile Something
                      </Text>
                  </Block>
                </Block>
              </Block>
